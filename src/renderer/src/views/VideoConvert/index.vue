<template>
  <div class="tool-container">
    <div class="page-header">
      <h2>视频转换裁剪</h2>
      <p class="subtitle">支持 MP4, WEBM, AVI, MKV, MOV 格式及精确裁剪</p>
    </div>
    ...
    <div class="content-card">
      ...
      <div v-if="sourceFile" class="media-player-section">
        <div class="player-wrapper">
          <video :src="previewUrl" controls class="native-video-player"></video>
        </div>
      ...
      >
        <div class="upload-placeholder">
          ...
          <div class="upload-text">将视频文件拖到此处，或 <em>点击选择</em></div>
        </div>
      </el-upload>
        ...
        >
          <el-form-item label="目标格式">
            <el-select v-model="targetFormat" style="width: 100%">
              <el-option label="MP4 (.mp4)" value="mp4" />
              <el-option label="WEBM (.webm)" value="webm" />
              <el-option label="AVI (.avi)" value="avi" />
              <el-option label="MKV (.mkv)" value="matroska" />
              <el-option label="MOV (.mov)" value="mov" />
            </el-select>
          </el-form-item>
